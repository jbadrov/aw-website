jQuery( document ).ready( function( $ ) {
    jQuery( "#btnAdd" ).click ( function() {
        ...
        if( jQuery( "#contact_name" ).length > 0 && jQuery( "#contact_name" ).val() == '' ) {
        ...
        if ( terms_conditions.isset_captcha ) {
            if ( 'recaptcha' == terms_conditions.captcha_version ) {
                if ( jQuery( "#recaptcha_response_field" ).length == 0 || jQuery( "#recaptcha_response_field" ).val() == '' ) {
                    msg += "Captcha required.<br/>";
                }
            } else {
                if( jQuery( "#g-recaptcha-response" ).length == 0 || jQuery( "#g-recaptcha-response" ).val() == '' )
                    msg += "Captcha required.<br/>";
            }
        }
