...
jQuery(document).ready(function() {
    ...
    jQuery( '.wpc_client_client_pages_list .wpc_apply_sort' ).click( function() {
        ...
        jQuery.ajax({
            ...
            data: 'action=wpc_pagel_shortcode_list_pagination&shortcode_data=' + jQuery.base64Encode( JSON.stringify( php_data.data ) ) + '&search=' + search + '&sorting=' + sorting + '&current_page=' + page_number + '&last_category_id=' + last_category_id + '&client_id=' + client_id + '&security=' + _wpnonce + '&sort_button=1',
            dataType: "json",
    ...
    jQuery( '.wpc_client_client_pages_list .wpc_pages_search_button' ).click( function() {
        ...
        jQuery.ajax({
            type: 'POST',
            url: php_data.ajax_url,
            data: 'action=wpc_pagel_shortcode_list_pagination&shortcode_data=' + jQuery.base64Encode( JSON.stringify( php_data.data ) ) + '&search=' + search + '&sorting=' + sorting + '&current_page=' + page_number + '&last_category_id=' + last_category_id + '&client_id=' + client_id + '&security=' + _wpnonce,
            dataType: "json",
            success: function( data ){
                if( !data.status ) {
                    alert( data.message );
