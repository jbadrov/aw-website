...
<form action="" method="post" name="wpc_settings" id="wpc_settings" >
 ...
 $page_setting = ''; $page_setting = ( isset( $wpc_pages[$page['id']] ) ) ? $wpc_pages[$page['id']] : 0; $args = array( 'name' => 'wpc_pages['. $page['id'] . ']', 'id' => $page['id'], 'sort_column' => 'menu_order', 'sort_order' => 'ASC', 'show_option_none' => ' ', 'echo' => false, 'selected' => $page_setting ); $dropdown_pages = wp_dropdown_pages( $args ); if ( $dropdown_pages ) { if ( $page['shortcode'] ) { $for_check_content = "onchange='jQuery( this ).check_page_shortcode(\"" . $page['content'] . "\", \"" . $page['id'] . "\");'"; } else { $for_check_content = "onchange='jQuery( this ).check_page_shortcode(\"\", \"" . $page['id'] . "\");'"; } echo str_replace( ' id=', " data-placeholder='" . __( 'Select Page', WPC_CLIENT_TEXT_DOMAIN ) . "' style='width: 265px;' " . $for_check_content . " class='chzn-select' id=", wp_dropdown_pages( $args ) ); } else { echo '<select data-placeholder="' . __( 'Select Page', WPC_CLIENT_TEXT_DOMAIN ) . '" class="chzn-select" style="width: 265px;"></select>'; } ?>
                    ...
                    <td width="30">
                        <?php
 $warning = 0; $style = ''; if ( 0 == $page_setting ) { $style = "style='display: block;' class='validate_page_icon_attention'"; } else { $page_content = get_page( $page_setting ); if ( !$page_content ) { $style = "style='display: block;' class='validate_page_icon_attention'"; } elseif ( '' != $page['content'] && false === strpos( $page_content->post_content, $page['content'] ) && $page['shortcode'] ) { $warning = 1; $style = "style='display: block;' class='validate_page_icon_warning'"; } else { $style = "style='display: block;' class='validate_page_icon_ok'"; } } ?>
