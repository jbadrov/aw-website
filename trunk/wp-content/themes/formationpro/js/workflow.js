...
function show_job(data) {
    ...
    task_output += (data.account_name) ? '<div class="col-md-12 form-group"><div class="col-xs-12 col-sm-4"><b>Client:</b></div><div class="col-xs-12 col-sm-6">' + data.account_name + '<br> </div></div>' : '';

    task_output += (data.deliverable_name) ? '<div class="col-md-12 form-group"><div class="col-xs-12 col-sm-4"><b>Deliverable:</b></div><div class="col-xs-12 col-sm-6">' + data.deliverable_name +'</div></div>' : '';
    ...
    notes_output += (data.stopping_point) ? '<div class="col-md-12"><b>Previous Stopping Point:</b> ' + data.stopping_point+'</div>'  : '';
	notes_output += '</div>';
