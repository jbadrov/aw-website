...
function show_job(data){
	...
	task_output +='<div class="col-md-12 form-group"><div class="col-md-4"><b>Deliverable:</b></div><div class="col-md-6">'+((data.account_name)?data.account_name+'<br>':'')+((data.deliverable_name)?data.deliverable_name:'')+'</div></div>';
