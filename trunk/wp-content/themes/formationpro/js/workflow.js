...
function show_job(data) {
    ...
    notes_output += (data.stopping_point) ? '<b>Previous Stopping Point:</b> ' + data.stopping_point+'<br>'  : '';
    notes_output += (data.production_notes) ? '<b>Production Notes:</b><p>' + data.production_notes + '</p>' : '';
