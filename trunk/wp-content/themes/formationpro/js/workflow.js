...
function show_job(data){
	...
	task_output +=(data.account_name && data.deliverable_name )?'<div class="col-md-12 form-group"><div class="col-md-4"><b>Deliverable:</b></div><div class="col-md-6">'+((data.account_name)?data.account_name+'<br>':'')+((data.deliverable_name)?data.deliverable_name:'')+'</div></div>':'';
	...
	task_output +=(data.parameter_2)?'<div class="col-md-12 form-group"><div class="col-md-4"><b>Parameter 1:</b></div><div id="copy2_text" class="col-md-6">'+data.parameter_2+'</div><div class="col-md-2"><button class="btn" data-clipboard-action="copy" data-clipboard-target="#copy2_text">Copy 2</button></div></div>':'';
	...
	notes_output += (data.stopping_point)?'<h4><b>Previous Stopping Point:</b></h4><p>'+data.stopping_point+'</p>':'';
	notes_output += (data.production_notes)?'<h4><b>Production Notes:</b></h4><p>'+data.production_notes+'</p>':'';
	...
	stop_output_left += '<div id="action_stopping_point_block" class="col-md-12 form-group" style="display:none"><div class="col-md-5"><b>Stopping Point:</b></div><div class="col-md-7"><input id="action_stopping_point" type="text"/></div></div>';
