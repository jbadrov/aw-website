...
function show_job(data) {
    ...
    task_output += '</div>';
    task_output += (data.parameter_1) ? '<hr style="width:100%"><br/><div class="col-md-12 form-group"><div class="col-md-4"><b>Parameter 1:</b></div><div id="copy1_text" class="col-md-6">' + data.parameter_1 + '</div><div class="col-md-2"><button class="btn" data-clipboard-action="copy" data-clipboard-target="#copy1_text">Copy 1</button></div></div>' : '';
