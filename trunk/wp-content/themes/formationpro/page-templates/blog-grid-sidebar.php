            ...
            <div class="gridblock">
                <div class="hentry">
                    ...
                    <div class="entry-content">
                        <?php echo htmlspecialchars(substr($page->post_content, 0, 190)) ?>...<div class="grid-more-link"><a href="<?php echo get_permalink($page->ID) ?>"> <?php $call2action = get_post_meta ($page->ID,'call2action', true ); if(!$call2action)$call2action="Read More";  echo __($call2action, 'formationpro'); ?></a>
                    </div><!-- .entry-content -->
                </div><!-- .hentry -->
            </div><!-- .gridblock -->
            <?php  endforeach; ?>
