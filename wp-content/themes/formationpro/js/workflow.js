...
function show_job(data) {
    ...
    task_output += (data.account_name=='null') ?'': '<div class="col-md-12 form-group"><div class="col-md-4"><b>Client:</b></div><div class="col-md-6">' + ((data.account_name) ? data.account_name + '<br>' : '') + '</div></div>' ;
