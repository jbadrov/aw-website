                ...
                <li>
                  ...
                  <div class="caption_wrap">
                    <div class="flex-caption">
                      ...
                      <p><?php $slide_desc = get_post_meta(get_the_ID(),'description',true); echo ($slide_desc)?substr(trim($slide_desc),0,250):esc_html(get_slider_excerpt()); ?> <a href="<?php the_permalink() ?>">...</a></p>
                    </div>
                  </div>
                </li>
              <?php endwhile; ?>
