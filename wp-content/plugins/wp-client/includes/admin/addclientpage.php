...
<div class='wrap'>
    ...
    <div class="wpc_clear"></div>
        ...
        <div id="wpc_container">
            ...
            <?php
 if ( isset( $_GET['msg'] ) ) { switch( $_GET['msg'] ) { case 'a': echo '<div id="message" class="updated wpc_notice fade"><p>' . sprintf( __( '%s is added.', WPC_CLIENT_TEXT_DOMAIN ), $this->custom_titles['portal']['s'] ) . '</p></div>'; break; } } ?>
                            ...
                            <td style="border-right:#666 solid 2px; width:220px; height:400px; vertical-align:top;">
                                ...
                                <p>
                                    <select name="change_page" id="change_page">
                                        ...
                                        <?php
 foreach ( $all_filter_page as $type_filter ) { $selected = ( isset( $_POST['change_page'] ) && $type_filter == $_POST['change_page'] ) ? ' selected' : '' ; echo '<option value="' . $type_filter . '"' . $selected . ' >'; if ( 'page' == $type_filter ) _e( 'Page', WPC_CLIENT_TEXT_DOMAIN ); else if ( 'portal_page' == $type_filter ) echo $this->custom_titles['portal']['s']; echo '</option>'; } ?>
                                    </select>
                                </p>
                                <p id="p_page">
 ...
 $categories = $this->acc_get_clientspage_categories(); if ( 0 != count( $categories ) ) { foreach( $categories as $value ) { ?>
                                                <option value='<?php echo $value['cat_id'] ?>'><?php _e( $value['cat_name'] , WPC_CLIENT_TEXT_DOMAIN ); ?></option>
                                            <?php } } ?>
                                    </select>
                                </p>
                                <p>
