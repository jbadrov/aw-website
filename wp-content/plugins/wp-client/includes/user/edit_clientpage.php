...
<div class='registration_form'>
    ...
    <form method="post" name="edit_clientpage" id="edit_clientpage" >
        ...
        <div class="postarea" id="postdivrich">
            <?php
 $clientpage_content = ( isset( $_POST['clientpage_content'] ) ) ? $_POST['clientpage_content'] : $clientpage['post_content']; wp_editor($clientpage_content, 'clientpage_content' ); ?>
        </div>
