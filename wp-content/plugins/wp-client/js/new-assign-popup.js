...
jQuery( document ).ready( function() {
    ...
    jQuery('body').on( 'click', ".wpc_fancybox_link", function() {
        ...
        if( data_callback != '' && typeof( window[ data_callback + '_link_click' ] ) == 'function' ) {
            //window[ data_callback + '_link_click' ]();
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                jQuery('#TB_ajaxContent').css('height', 'auto !important');

                if( typeof( data.display ) != 'undefined' ) {
                    jQuery('#TB_window .wpc_show').val( data.display );
                }

                if( typeof( data.order ) != 'undefined' ) {
                    jQuery('#TB_window .wpc_order').val( data.order );
                }
