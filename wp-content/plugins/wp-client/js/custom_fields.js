jQuery(document).ready(function() {
    ...
    jQuery( 'input[type="submit"]:not(#loginform #wp-submit)' ).click( function() {
        ...
        jQuery( '.wpc_text_required, .wpc_cost_required, .wpc_textarea_required, .wpc_sbox_required, .wpc_msbox_required' ).each( function() {
    ...
    jQuery('.wpc_cf_text.wpc_field_mask_custom').each(function() {
        ...
        jQuery(this).mask( mask, {clearIfNotMatch: true} );
    });
